/*
  ...
  - You are about to drop the column `checkResolutions` on the `Uptime` table. All the data in the column will be lost.
...
CREATE TABLE "new_Uptime" (
    ...
    "checkResolution" BOOLEAN NOT NULL DEFAULT false
);
