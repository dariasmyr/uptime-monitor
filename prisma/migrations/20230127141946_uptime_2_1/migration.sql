/*
  ...
  - You are about to drop the column `httpCheckStatusCode` on the `Uptime` table. All the data in the column will be lost.
  - Added the required column `httpCheckMessage` to the `Uptime` table without a default value. This is not possible if the table is not empty.
